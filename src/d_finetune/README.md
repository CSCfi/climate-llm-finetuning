...
In this part, we will finetune a small LLM (8B sized model) with the dataset we created in [the previous part](../c_qa/). We will use 2 nodes and all of their GPUs, so 16 GPUs in total. In this version, singularity container provided by LUMI AI Factory will be utilized.
...
`sbatch src/d_finetune/6_run_finetune_lumi_gpu16.sh meta-llama/Llama-3.1-8B-Instruct climate-llm-finetuning/ft_data_8b climate-llm-finetuning/data/extracted_texts_from_xml_pdf_qa_4096.json 16 14`
