...
#SBATCH --ntasks=1
#SBATCH --output=./log/create_a/%j/output.log
#SBATCH --error=./log/create_a/%j/error.log
...
VLLM_LOG=$PWD/log/create_a/${SLURM_JOB_ID}/vllm.log
